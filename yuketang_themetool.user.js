...
*/
        ...
        for (var i = 0; i < marks.length; i++) {
            if (!marks[i].hasAttribute("set")) {
                marks[i].setAttribute(
                    "src",
                    card_mark_list[randInt(0, card_mark_list.length)]
                );
    ...
    function changeWaterMark_code1(jNode) {
        var card_list = document.querySelectorAll(".lesson-cardT");
    ...
    function colorGradient(original_color, ratio) {
        ...
        if (original_color.length == 4) {
            // #XXX
            hex_color = parseInt(original_color.slice(1), 16);
            ...
            if (ratio > 0) {
                r = r + parseInt(ratio * (max_hex_color - r));
                g = g + parseInt(ratio * (max_hex_color - g));
                b = b + parseInt(ratio * (max_hex_color - b));
            } else if (ratio < 0) {
    ...
    function loadUserSettings() {
        var tmp_user_settings_dic = GM_getValue("yuketang_user_settings", null);
        ...
        var tmp_color_dic = GM_getValue("yuketang_color_set", null);
        if (tmp_color_dic) {
    ...
    if (isBirthday()) {
        ...
        var year = GM_getValue("yeketang_birthday_year", null);
        var date = new Date();
        if (year == null || year != date.getFullYear()) {
            // 没有祝贺过，祝贺
            trigger_birthday = true; // 彩虹屁变成生日快乐
            GM_setValue("yeketang_birthday_year", date.getFullYear());
            // 放烟花
    ...
    if (user_settings.enable_card_style) {
        ...
        // card color
        for (var i = 0; i < color_set.card_color_list[0].length; i++) {
            ...
            }, ${colorGradient(color_set.card_color_list[0][i], 0.3)});}`;
            // if (server_code == 1) {
        ...
        // card watermark
        GM_addStyle(".mark > img {opacity:0.5; transform:scale(0.5);}");
    ...
    if (user_settings.enable_index_page) {
        ...
        GM_addStyle(index_header_button_group_isactive_style);
    ...
    if (user_settings.enable_developing_features) {
        ...
        GM_addStyle(repo_cloud_upload_and_newfile_button_style);
        ...
        GM_addStyle(repo_cloud_upload_and_newfile_button_hover_style);
        // that little arrow
        ...
        {
            background-color:${color_set.text_color_secondary} !important;
        }
        ...
        .studentmark-wrapper .personal-mark .scheme .info {
            color:${color_set.text_color_subordinate} !important;
        }
        circle
        {
    ...
    function insertZhuangBiStr(eltab_whole, reference_node) {
            ...
            GM_xmlhttpRequest({
                ...
                onload: function (res) {
                    if (res.status == 200) {
                        ...
                        new_node.innerHTML =
                            json_dic.hitokoto + "    " + "——" + json_dic.from;
                        eltab_whole.insertBefore(new_node, reference_node);
                        GM_addStyle(
    ...
    function insertRainbowFartStr(eltab_whole, reference_node) {
        try {
            GM_xmlhttpRequest({
                method: "get",
    ...
    function insertChickenSoupStr(eltab_whole, reference_node) {
        try {
            GM_xmlhttpRequest({
                method: "get",
    ...
    function addGreeting(jNode) {
        ...
        if (trigger_birthday) {
            ...
            var age = parseInt(tmp_date.getFullYear()) - 2001;
        ...
        switch (user_settings.enable_greeting) {
            case 1:
                insertZhuangBiStr(eltab_whole, reference_node);
                break;
            case 2:
                insertRainbowFartStr(eltab_whole, reference_node);
                break;
            case 3:
                insertChickenSoupStr(eltab_whole, reference_node);
                break;
            default:
                break;
        }
    ...
    function showUserSettings() {
        setUpUserSettings();
        document
            .getElementById("user_script_user_settings_whole")
    ...
    var user_settings_css_style_sheet = getUserSettingsCss();
    GM_addStyle(user_settings_css_style_sheet);
    ("html sheet");

    function getColorAccordingToBackgroundColor(background) {
    ...
    <div id="user_script_user_settings_whole" class="user_script_user_settings" style="
        ...
        <div id="background_color_main" class="user_script_user_settings one_selection">
            ...
            <span id="ususcc_bg_main" class="user_script_user_settings_change_color" onclick="setColorValueOf(this)" style="
                        ...
                        border-radius: 4px;
                        background-color:${color_set.background_color_main};
        ...
        <div id="text_color_main" class="user_script_user_settings one_selection">
            ...
            <span id="ususcc_text_main" class="user_script_user_settings_change_color" onclick="setColorValueOf(this)" style="
                        border: 2px solid black;
                        border-radius: 4px;
                        background-color:${color_set.text_color_main};
                        color:${getColorAccordingToBackgroundColor(
        ...
        <div id="text_color_secondary" class="user_script_user_settings one_selection">
            ...
            <span id="ususcc_text_sc" class="user_script_user_settings_change_color" onclick="setColorValueOf(this)" style="
                        border: 2px solid black;
                        border-radius: 4px;
                        background-color:${color_set.text_color_secondary};
                        color:${getColorAccordingToBackgroundColor(
        ...
        <div id="text_color_subordinate" class="user_script_user_settings one_selection">
            ...
            <span id="ususcc_text_sb" class="user_script_user_settings_change_color" onclick="setColorValueOf(this)" style="
                        border: 2px solid black;
                        border-radius: 4px;
                        background-color:${color_set.text_color_subordinate};
                        color:${getColorAccordingToBackgroundColor(
        ...
        <div id="card_style_colors" class="user_script_user_settings one_selection">
            ...
            <span id="ususcc_card_color_0" class="user_script_user_settings_change_color" onclick="setColorValueOf(this)" style="
                        border: 2px solid black;
                        border-radius: 4px;
                        background-color:${color_set.card_color_list[0][0]};
                        color:${getColorAccordingToBackgroundColor(
        ...
        <div id="card_style_colors" class="user_script_user_settings one_selection">
            ...
            <span id="ususcc_card_color_1" class="user_script_user_settings_change_color" onclick="setColorValueOf(this)" style="
                        border: 2px solid black;
                        border-radius: 4px;
                        background-color:${color_set.card_color_list[0][1]};
                        color:${getColorAccordingToBackgroundColor(
        ...
        <div id="card_style_colors" class="user_script_user_settings one_selection">
            ...
            <span id="ususcc_card_color_2" class="user_script_user_settings_change_color" onclick="setColorValueOf(this)" style="
                        border: 2px solid black;
                        border-radius: 4px;
                        background-color:${color_set.card_color_list[0][2]};
                        color:${getColorAccordingToBackgroundColor(
        ...
        <div id="card_style_colors" class="user_script_user_settings one_selection">
            ...
            <span id="ususcc_card_color_3" class="user_script_user_settings_change_color" onclick="setColorValueOf(this)" style="
                        border: 2px solid black;
                        border-radius: 4px;
                        background-color:${color_set.card_color_list[0][3]};
                        color:${getColorAccordingToBackgroundColor(
        ...
        <div>
            ...
            <input type="radio" name="us_enable_greeting" ${
                user_settings.enable_greeting == 1 ? "checked" : ""
            ...
            <input type="radio" name="us_enable_greeting" ${
                user_settings.enable_greeting == 2 ? "checked" : ""
            ...
            <input type="radio" name="us_enable_greeting" ${
                user_settings.enable_greeting == 3 ? "checked" : ""
            } id="us_chicken_soup_radio" style="width:20px;height:20px;appearance:button;" />&nbsp; &nbsp; 
            关闭问好
            <input type="radio" name="us_enable_greeting" ${
                user_settings.enable_greeting == 0 ? "checked" : ""
    ...
    function setUpUserSettings() {
        ...
        //bind keys
        var apply_btn = document.getElementById("usus_apply");
        ...
        var reset_btn = document.getElementById("usus_reset");
    ...
    function addFunctions() {
        var new_script_block = document.createElement("script");
        ...
        document.getElementsByTagName("body")[0].appendChild(new_script_block);
    }

    ("set up user settings");

    function recordUserSettings(user_settings_dic, color_set_dic) {
        ...
        color_set_dic.background_color_secondary = document
            ...
            .innerHTML.trim();
        color_set_dic.background_color_subordinate = document
        ...
        user_settings_dic.enable_left_menu = document.getElementById(
            "us_left_menu_checkbox"
        ).checked;
        user_settings_dic.enable_card_style = document.getElementById(
            "us_card_style_checkbox"
        ).checked;
        user_settings_dic.enable_index_page = document.getElementById(
            "us_index_page_checkbox"
        ).checked;
        if (document.getElementById("us_zhuang_bi_radio").checked) {
            user_settings_dic.enable_greeting = 1;
        } else if (document.getElementById("us_rainbow_fart_radio").checked) {
            user_settings_dic.enable_greeting = 2;
        } else if (document.getElementById("us_chicken_soup_radio").checked) {
            user_settings_dic.enable_greeting = 3;
        } else if (document.getElementById("us_no_greeting_radio").checked) {
            user_settings_dic.enable_greeting = 0;
        }
        user_settings_dic.enable_developing_features = document.getElementById(
            "us_developing_features_checkbox"
        ).checked;
        GM_setValue("yuketang_color_set", color_set_dic);
        GM_setValue("yuketang_user_settings", user_settings_dic);
        hideUserSettings();
    }
